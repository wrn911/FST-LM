...
python federated_train.py \
    ...
    --save_dir result/FSTLM/milano/net \
    --device cuda:0
...
python federated_train.py \
    ...
    --min_correlation_threshold 0.5 \
    --constraint_correction_weight 0.3 \
    --save_dir result/FSTLM/milano/call \
    --device cuda:0
...
python federated_train.py \
    ...
    --min_correlation_threshold 0.5 \
    --constraint_correction_weight 0.3 \
    --save_dir result/FSTLM/milano/sms \
    --device cuda:0
...
python federated_train.py \
    ...
    --min_correlation_threshold 0.5 \
    --constraint_correction_weight 0.3 \
    --save_dir result/FSTLM/trento/net \
    --device cuda:0
...
python federated_train.py \
    ...
    --min_correlation_threshold 0.5 \
    --constraint_correction_weight 0.3 \
    --save_dir result/FSTLM/trento/call \
    --device cuda:0
...
python federated_train.py \
    ...
    --min_correlation_threshold 0.5 \
    --constraint_correction_weight 0.3 \
    --save_dir result/FSTLM/trento/sms \
    --device cuda:0
echo "=== 训练完成 ==="